        ...
        <div class="Mealsborder">
            ...
            <article class="formmeals">
                    <form action="{{ url('/admin/meal/create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Name Food</label>
                            <input type="text" name="NameFood" class="form-control" id="exampleFormControlInput1" placeholder="Name Food">
                        </div>
                        <div class="mb-3">
